...
procedure Register;
begin
  RegisterComponents('Gary"s Stuff', [TMemoBar]);
end;
...
function TMemoBar.GetSavedFileNamePanel: TPanel;
var
  txt : string;
begin
...
function TMemoBar.GetSavedStatusPanel: TPanel;
var
  txt : string;
begin
...
procedure TMemoBar.FileNameClick(Sender: TObject);
begin
...
procedure TMemoBar.SetMemo(const Value: TRichEdit);
begin
...
procedure TMemoBar.SetSavedState(const Value: TSavedState);
begin
  fTextchanged := Value;
  UpdateSavedStatus;
end;
...
procedure TMemoBar.SetFileName(const Value: string);
begin
  fFileName := Value;
  UpdateFileName;
end;
...
procedure TMemoBar.UpdateFileName;
var
  chars : string;
begin
...
procedure TMemoBar.UpdateSavedStatus;
begin
  if NOT Assigned(Memo) then begin

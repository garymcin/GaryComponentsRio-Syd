...
// $Rev: 41960 $
// File generated on 4/16/2012 8:33:06 PM from Type Library described below.
...
//   Error creating palette bitmap of (TADOX2Table) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2Column) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2Index) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2Key) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2Group) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2User) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
//   Error creating palette bitmap of (TADOX2Catalog) : Server C:\Program Files (x86)\Common Files\System\ado\msadox.dll contains no icons
// ************************************************************************ //
...
// TypeFlags        : (2) CanCreate
// *********************************************************************//
  TADOX2Catalog = class(TOleServer)
  private
    FIntf: _Catalog;
...
procedure TADOX2Table.InitServerData;
const
...
procedure TADOX2Table.ConnectTo(svrIntf: _Table);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Table.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Table.GetDefaultInterface: _Table;
begin
  if FIntf = nil then
    Connect;
...
constructor TADOX2Table.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Table.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Table.Get_Columns: Columns;
begin
  Result := DefaultInterface.Columns;
end;

function TADOX2Table.Get_Name: WideString;
begin
  Result := DefaultInterface.Name;
end;

procedure TADOX2Table.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Name := pVal;
end;

function TADOX2Table.Get_type_: WideString;
begin
  Result := DefaultInterface.type_;
end;

function TADOX2Table.Get_Indexes: Indexes;
begin
  Result := DefaultInterface.Indexes;
end;

function TADOX2Table.Get_Keys: Keys;
begin
  Result := DefaultInterface.Keys;
end;

function TADOX2Table.Get_Properties: Properties;
begin
  Result := DefaultInterface.Properties;
end;

function TADOX2Table.Get_DateCreated: OleVariant;
begin
  Result := DefaultInterface.DateCreated;
end;

function TADOX2Table.Get_DateModified: OleVariant;
begin
  Result := DefaultInterface.DateModified;
end;

function TADOX2Table.Get_ParentCatalog: _Catalog;
begin
  Result := DefaultInterface.ParentCatalog;
end;

procedure TADOX2Table.Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;

procedure TADOX2Table._Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;
...
procedure TADOX2Column.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2Column.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
...
procedure TADOX2Column.ConnectTo(svrIntf: _Column);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Column.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Column.GetDefaultInterface: _Column;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2Column.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Column.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Column.Get_Name: WideString;
begin
  Result := DefaultInterface.Name;
end;

procedure TADOX2Column.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Name := pVal;
end;

function TADOX2Column.Get_Attributes: ColumnAttributesEnum;
begin
  Result := DefaultInterface.Attributes;
end;

procedure TADOX2Column.Set_Attributes(pVal: ColumnAttributesEnum);
begin
  DefaultInterface.Attributes := pVal;
end;

function TADOX2Column.Get_DefinedSize: Integer;
begin
  Result := DefaultInterface.DefinedSize;
end;

procedure TADOX2Column.Set_DefinedSize(pVal: Integer);
begin
  DefaultInterface.DefinedSize := pVal;
end;

function TADOX2Column.Get_NumericScale: Byte;
begin
  Result := DefaultInterface.NumericScale;
end;

procedure TADOX2Column.Set_NumericScale(pVal: Byte);
begin
  DefaultInterface.NumericScale := pVal;
end;

function TADOX2Column.Get_Precision: Integer;
begin
  Result := DefaultInterface.Precision;
end;

procedure TADOX2Column.Set_Precision(pVal: Integer);
begin
  DefaultInterface.Precision := pVal;
end;

function TADOX2Column.Get_RelatedColumn: WideString;
begin
  Result := DefaultInterface.RelatedColumn;
end;

procedure TADOX2Column.Set_RelatedColumn(const pVal: WideString);
begin
  DefaultInterface.RelatedColumn := pVal;
end;

function TADOX2Column.Get_SortOrder: SortOrderEnum;
begin
  Result := DefaultInterface.SortOrder;
end;

procedure TADOX2Column.Set_SortOrder(pVal: SortOrderEnum);
begin
  DefaultInterface.SortOrder := pVal;
end;

function TADOX2Column.Get_type_: DataTypeEnum;
begin
  Result := DefaultInterface.type_;
end;

procedure TADOX2Column.Set_type_(pVal: DataTypeEnum);
begin
  DefaultInterface.type_ := pVal;
end;

function TADOX2Column.Get_Properties: Properties;
begin
  Result := DefaultInterface.Properties;
end;

function TADOX2Column.Get_ParentCatalog: _Catalog;
begin
  Result := DefaultInterface.ParentCatalog;
end;

procedure TADOX2Column.Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;

procedure TADOX2Column._Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;
...
procedure TADOX2Index.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2Index.ConnectTo(svrIntf: _Index);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Index.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Index.GetDefaultInterface: _Index;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2Index.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Index.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Index.Get_Name: WideString;
begin
  Result := DefaultInterface.Name;
end;

procedure TADOX2Index.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Name := pVal;
end;

function TADOX2Index.Get_Clustered: WordBool;
begin
  Result := DefaultInterface.Clustered;
end;

procedure TADOX2Index.Set_Clustered(pVal: WordBool);
begin
  DefaultInterface.Clustered := pVal;
end;

function TADOX2Index.Get_IndexNulls: AllowNullsEnum;
begin
  Result := DefaultInterface.IndexNulls;
end;

procedure TADOX2Index.Set_IndexNulls(pVal: AllowNullsEnum);
begin
  DefaultInterface.IndexNulls := pVal;
end;

function TADOX2Index.Get_PrimaryKey: WordBool;
begin
  Result := DefaultInterface.PrimaryKey;
end;

procedure TADOX2Index.Set_PrimaryKey(pVal: WordBool);
begin
  DefaultInterface.PrimaryKey := pVal;
end;

function TADOX2Index.Get_Unique: WordBool;
begin
  Result := DefaultInterface.Unique;
end;

procedure TADOX2Index.Set_Unique(pVal: WordBool);
begin
  DefaultInterface.Unique := pVal;
end;

function TADOX2Index.Get_Columns: Columns;
begin
  Result := DefaultInterface.Columns;
end;

function TADOX2Index.Get_Properties: Properties;
begin
  Result := DefaultInterface.Properties;
end;
...
procedure TADOX2Key.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2Key.ConnectTo(svrIntf: _Key);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Key.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Key.GetDefaultInterface: _Key;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2Key.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Key.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Key.Get_Name: WideString;
begin
  Result := DefaultInterface.Name;
end;

procedure TADOX2Key.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Name := pVal;
end;

function TADOX2Key.Get_DeleteRule: RuleEnum;
begin
  Result := DefaultInterface.DeleteRule;
end;

procedure TADOX2Key.Set_DeleteRule(pVal: RuleEnum);
begin
  DefaultInterface.DeleteRule := pVal;
end;

function TADOX2Key.Get_type_: KeyTypeEnum;
begin
  Result := DefaultInterface.type_;
end;

procedure TADOX2Key.Set_type_(pVal: KeyTypeEnum);
begin
  DefaultInterface.type_ := pVal;
end;

function TADOX2Key.Get_RelatedTable: WideString;
begin
  Result := DefaultInterface.RelatedTable;
end;

procedure TADOX2Key.Set_RelatedTable(const pVal: WideString);
begin
  DefaultInterface.RelatedTable := pVal;
end;

function TADOX2Key.Get_UpdateRule: RuleEnum;
begin
  Result := DefaultInterface.UpdateRule;
end;

procedure TADOX2Key.Set_UpdateRule(pVal: RuleEnum);
begin
  DefaultInterface.UpdateRule := pVal;
end;

function TADOX2Key.Get_Columns: Columns;
begin
  Result := DefaultInterface.Columns;
end;
...
procedure TADOX2Group.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2Group.ConnectTo(svrIntf: _Group);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Group.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Group.GetDefaultInterface: _Group;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2Group.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Group.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Group.Get_Properties: Properties;
begin
  Result := DefaultInterface.Properties;
end;

function TADOX2Group.Get_ParentCatalog: _Catalog;
begin
  Result := DefaultInterface.ParentCatalog;
end;

procedure TADOX2Group.Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;

procedure TADOX2Group._Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;
...
procedure TADOX2User.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2User.ConnectTo(svrIntf: _User);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2User.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2User.GetDefaultInterface: _User;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2User.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2User.Destroy;
begin
  inherited Destroy;
end;

function TADOX2User.Get_Properties: Properties;
begin
  Result := DefaultInterface.Properties;
end;

function TADOX2User.Get_ParentCatalog: _Catalog;
begin
  Result := DefaultInterface.ParentCatalog;
end;

procedure TADOX2User.Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;

procedure TADOX2User._Set_ParentCatalog(const ppvObject: _Catalog);
begin
  DefaultInterface.ParentCatalog := ppvObject;
end;
...
procedure TADOX2Catalog.InitServerData;
const
  CServerData: TServerData = (
...
procedure TADOX2Catalog.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
...
procedure TADOX2Catalog.ConnectTo(svrIntf: _Catalog);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TADOX2Catalog.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TADOX2Catalog.GetDefaultInterface: _Catalog;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call "Connect" or "ConnectTo" before this operation');
...
constructor TADOX2Catalog.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;

destructor TADOX2Catalog.Destroy;
begin
  inherited Destroy;
end;

function TADOX2Catalog.Get_Tables: Tables;
begin
  Result := DefaultInterface.Tables;
end;

function TADOX2Catalog.Get_ActiveConnection: OleVariant;
begin
  Result := DefaultInterface.Get_ActiveConnection;
end;

procedure TADOX2Catalog.Set_ActiveConnection(pVal: OleVariant);
begin
  DefaultInterface.Set_ActiveConnection(pVal);
end;

procedure TADOX2Catalog._Set_ActiveConnection(const pVal: IDispatch);
begin
  DefaultInterface._Set_ActiveConnection(pVal);
end;

function TADOX2Catalog.Get_Procedures: Procedures;
begin
  Result := DefaultInterface.Procedures;
end;

function TADOX2Catalog.Get_Views: Views;
begin
  Result := DefaultInterface.Views;
end;

function TADOX2Catalog.Get_Groups: Groups;
begin
  Result := DefaultInterface.Groups;
end;

function TADOX2Catalog.Get_Users: Users;
begin
  Result := DefaultInterface.Users;
end;

function TADOX2Catalog.Create1(const ConnectString: WideString): OleVariant;
begin
  Result := DefaultInterface.Create(ConnectString);
end;

function TADOX2Catalog.GetObjectOwner(const ObjectName: WideString; ObjectType: ObjectTypeEnum): WideString;
var
...
function TADOX2Catalog.GetObjectOwner(const ObjectName: WideString; ObjectType: ObjectTypeEnum; 
                                      ObjectTypeId: OleVariant): WideString;
begin
  Result := DefaultInterface.GetObjectOwner(ObjectName, ObjectType, ObjectTypeId);
end;

procedure TADOX2Catalog.SetObjectOwner(const ObjectName: WideString; ObjectType: ObjectTypeEnum; 
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TADOX2Table, TADOX2Column, TADOX2Index, TADOX2Key, 
    TADOX2Group, TADOX2User, TADOX2Catalog]);
end;

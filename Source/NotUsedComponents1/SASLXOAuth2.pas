...
//   limitations under the License.
{
  ...
  to
    raise EOAuth2Exception.Create('Authentication failed');
  Gary McIntosh 8/21/2016 -- Delphi Berlin 10.1
...
uses
  ...
  REST.Utils, IPPeerClient;


procedure Register;
begin
  RegisterComponents('Gary"s Stuff', [TSASLXOAuth2]);
end;
...
function TSASLXOAuth2.GetVersion: string;
begin
  Result := VersionSASLXOAuth2;
end;

...
uses
  ...
  System.types, System.classes, System.SysUtils, System.math, System.strutils,
  System.inifiles,

  Vcl.graphics, Vcl.grids, Vcl.dbgrids, Vcl.Controls, Vcl.stdctrls, Vcl.forms,
  Vcl.dialogs, Vcl.imgList, Vcl.menus,
...
//    p := DataSource.DataSet.GetBookmark;
    ...
    if DataSource.DataSet.BookmarkValid(SavePlace) then begin
      DataSource.DataSet.GotoBookmark(SavePlace);
      DataSource.DataSet.FreeBookmark(SavePlace);
    end;
//    if DataSource.DataSet.BookmarkValid(p) then begin
...
//procedure Register;
//begin
//  RegisterComponents('Gary"s Stuff', [TEnhDBGrid]);
//end;
  ...
  if Message.Msg = WM_MOUSEWHEEL then begin
    ...
    if Message.WParam < 0 then begin
      ...
      if ctrlPressed then
        ...
        // vertical scroll
        if not DataSource.DataSet.Bof then begin
          DataSource.DataSet.Prior;
          InvalidateCol(0);
        end;
      end;

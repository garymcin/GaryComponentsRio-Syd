...
const
  ...
  PSEffects: array[1..174] of TEffect = (
...
//procedure fred(Display, Image: TBitmap; W, H, X, Y, Progress: Integer);
...
//procedure fred(Display, Image: TBitmap; W, H, X, Y, Progress: Integer);
//var
//  Rgn, TmpRgn, rgnFred: HRGN;
//begin
////  Rgn := CreatePolygonRgnEx([W, 0, 0, 0, W, Y]);
////  rgnFred := CreatePolygonRgnEx([W, 0, 0, 0, W, Y]);
////  DeleteObject(rgnFred);

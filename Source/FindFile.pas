  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          Handle := WinAPI.Windows.FindFirstFile(PChar(Path + FileMasks[I]), FindData);
          if Handle <> INVALID_HANDLE_VALUE then
           try
             ...
             until not WinAPI.Windows.FindNextFile(Handle, FindData);
           finally
      ...
      begin
        Handle := WinAPI.Windows.FindFirstFile(PChar(Path + '*.*'), FindData);
        if Handle <> INVALID_HANDLE_VALUE then
          try
            repeat
              if Aborted then Exit;

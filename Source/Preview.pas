...
uses
  ...
  Forms, Dialogs, StdCtrls, ExtCtrls, ComCtrls, Menus, Printers, System.UITypes;
...
type
  ...
  public
    ...
    property PrinterError: Boolean read fPrinterError;
...
begin
  try
    ...
    MessageDlg('Could not Set Printer for printing the maps!', mtError, [mbOK], 0);
    fPrinterError := True;
  end;
end;
{$ENDIF}

...
type
  TgemDBLookupComboBox = class(TDBLookupComboBox)
  private
...
//procedure Register;
//begin
//  RegisterComponents('Gary"s Stuff', [TgemDBLookupComboBox]);
//end;

{ TgemDBComboBox }

constructor TgemDBLookupComboBox.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TgemDBLookupComboBox.DoEnter;
begin
  OldBackColor := Color;
  Color := ColorOnEnter;
...
procedure TgemDBLookupComboBox.DoExit;
begin
  Color := OldBackColor;
...
procedure TgemDBLookupComboBox.KeyPress(var Key: Char);
begin

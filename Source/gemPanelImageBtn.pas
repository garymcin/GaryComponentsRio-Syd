...
//    property CaptionPosition default dpBottom;
//    property CaptionFont;//: TFont read FCaptionFont write SetCaptionFont;
//    property CaptionHeight;//: Integer read FCaptionHeight write SetCaptionHeight default 0;
//    property FlatButtons default False;//: Boolean read FFlat write SetFlat default False;
//    property Align;
//    property Buttons: TJvCapBtnStyles read FButtons write SetButtons;
//    property AutoDrag default False;//: Boolean read FAutoDrag write FAutoDrag default True;
//    property Buttons;//: TJvCapBtnStyles read FButtons write SetButtons;
//    property BorderStyle default bsSingle;
//    property Caption: string read FCaption write SetCaption;
//    property CaptionColor: TColor read FCaptionColor write SetCaptionColor default clActiveCaption;
...
//    property PopupMenu;
//    property Resizable default True;//:Boolean read FResizable write SetResizable default True;
//    property ShowHint;
//    property TabOrder;
//    property TabStop;
//    property Visible;
...
procedure TgemCaptionBtnImagePanel.OnImageMouseEnterHandler(
  Sender: TObject);
begin
...
procedure TgemCaptionBtnImagePanel.OnImageMouseLeaveHandler(
  Sender: TObject);
begin
  if fSelectedColor <> color then
